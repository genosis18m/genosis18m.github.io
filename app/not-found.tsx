...
export default function NotFound() {
  return (
    <main className="min-h-screen w-full flex flex-col items-center justify-center bg-[#0a0a0f] overflow-hidden" style={{ background: 'var(--bg)' }}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .speakers .g1 .g11, .speakers .g1 .g12, .speakers .g1 .g13 {
          width: 0.65em;
          height: 0.65em;
          border-radius: 50%;
          background-color: #7f5934;
      ...
      <div className="main_wrapper text-[#f27405]">
        <div className="main">
      ...
      <div className="mt-20 z-10 flex flex-col items-center gap-4">
        <p className="text-white/60 text-lg">Looks like you're lost in static.</p>
        <Link 
          href="/" 
          className="px-8 py-3 rounded-full bg-gradient-to-r from-purple-600 to-blue-500 text-white font-bold tracking-wide hover:scale-105 transition-all shadow-[0_0_20px_rgba(139,92,246,0.3)] hover:shadow-[0_0_30px_rgba(139,92,246,0.5)]"
        >
          Return to Hub
        </Link>
      </div>
